...
import { updateTransaction } from '@/wayfinder/App/Http/Controllers/TransactionController';
                                ...
                                <>
                                    ...
                                    <div className="flex gap-3 rounded-lg border border-blue-100 bg-blue-50 p-4">
                                        ...
                                        <p className="text-xs leading-relaxed text-blue-800 italic">
                                            Modifying the status updates the
                                            financial tracking of the associated
                                            project. Amount and Project links
